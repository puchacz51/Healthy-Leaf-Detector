...
class DatasetDownloader:
    def __init__(self):
        ...
        self.azure_storage_account_key = os.getenv('AZURE_STORAGE_ACCOUNT_KEY', 'kk')
        ...
        self.testEnv = os.getenv('TEST', 'nie tUTAJ')
    ...
    def upload_model(self, file_path, blob_name):
        ...
        print(self.azure_storage_account_key)
        print(self.testEnv)
...
# To upload a specific file with a specific name to the blob storage

downloader.upload_model("blob.py", "test.py")